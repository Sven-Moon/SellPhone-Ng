...
export class MockStaticDataInterceptor implements HttpInterceptor {
  ...
  Observable<HttpEvent<any>> {
    if (req.method === 'POST' && req.url == 'api/static-data') {
      // console.log('[Static Data Interceptor] Successful');
      ...
      // console.log('[Static Data Interceptor] phoneTypes:');
      ...
      // console.log('[Static Data Interceptor] phoneModelsByType:');
      // console.log(phoneModelsByType);
      const response = new HttpResponse({
